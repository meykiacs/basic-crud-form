...
export const EmployeeList = () => {
  ...
  if (employees.length === 0) return <Skeleton className="flex items-center bg-gray-100 mb-10 shadow" />
    ...
    <>
      {employees.map((employee) => (
        <div
          ...
          key={employee.id}
        >
          <div className="flex-auto text-start px-4 py-2 m-2 space-y-2">
          ...
          <div className="flex-auto text-end px-4 py-2 m-2">
